  ...
  return (
    <div className="py-12 bg-gray-50">
      ...
      <div className="mt-10 max-w-7xl mx-auto  ">
        <div className="flex bg-white rounded-lg shadow-lg hover:bg-gray-200 overflow-hidden">
      ...
      <div className="mt-10 max-w-7xl mx-auto grid grid-cols-1 gap-y-10 gap-x-8 lg:grid-cols-2">
        {features.map((feature, index) => (
          <div
            key={index}
            className="flex-col bg-white rounded-lg shadow-lg overflow-hidden hover:bg-gray-200 hover:cursor-pointer"
          >
            ...
            <div className="">
              <img
                className="h-80 w-80 p-8 rounded-lg"
